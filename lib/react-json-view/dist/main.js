if(typeof document !== 'undefined')! function(e, t) {
    ...
    return function(e) {
        ...
        var a = n(3),
            ...
            c = function(e, t, n) {
                ...
                for (l in d && (n = t), n)(u = !p && E && void 0 !== E[l]) && s(y, l) || (f = u ? E[l] : n[l], y[l] = d && "function" != typeof E[l] ? n[l] : v && u ? o(f, a) : m && E[l] == f ? function(e) {
        ...
        e.exports = function(e, t, n, b, h, v, m) {
            ...
            if (A && (E = u(A.call(new e))) !== Object.prototype && E.next && (l(E, x, !0), a || "function" == typeof E[f] || i(E, f, d)), _ && C && "values" !== C.name && (k = !0, S = function() {
                    return C.call(this)
                }), a && !m || !p && !k && O[f] || i(O, f, S), s[t] = S, s[x] = d, h)
                if (y = {
                        values: _ ? S : j("values"),
                        keys: v ? S : j("keys"),
                        entries: w
        ...
        var a = n(3),
            ...
            J = K && "symbol" == typeof D.iterator ? function(e) {
            ...
            $ = function(e, t) {
                y(e);
                for (var n, a = v(t = j(t)), r = 0, o = a.length; o > r;) Y(e, n = a[r++], t[n]);
                return e
            },
            Q = function(e) {
        ...
        i(i.S + i.F * oe, "Object", {
            ...
            stringify: function(e) {
                ...
                if (n = t = a[1], (g(t) || void 0 !== e) && !J(e)) return m(t) || (t = function(e, t) {
                    if ("function" == typeof n && (t = n.call(this, e, t)), !J(t)) return t
                }), a[1] = t, R.apply(I, a)
            }
        }), D.prototype[B] || n(6)(D.prototype, B, D.prototype.valueOf), f(D, "Symbol"), f(Math, "Math", !0), f(a.JSON, "JSON", !0)
    }, function(e, t, n) {
        var a = n(17)("meta"),
            r = n(11),
            o = n(5),
        ...
        e.exports = !l || n(8)((function() {
            ...
            for (var n = s(e), l = arguments.length, u = 1, f = o.f, p = i.f; l > u;)
                for (var d, b = c(arguments[u++]), h = f ? r(b).concat(f(b)) : r(b), v = h.length, m = 0; v > m;) d = h[m++], a && !p.call(b, d) || (n[d] = b[d]);
            return n
        } : l
    }, function(e, t, n) {
        "use strict";
        ...
        (function(t) {
            ...
            var j, x, _, k = Function.prototype,
                O = Object.prototype,
            ...
            function N(e, t, n, a) {
                for (var r = -1, o = e.length, i = n.length, s = -1, c = t.length, l = D(o - i, 0), u = Array(c + l), f = !a; ++s < c;) u[s] = t[s];
            ...
            function z(e, t, n, a) {
                for (var r = -1, o = e.length, i = -1, s = n.length, c = -1, l = t.length, u = D(o - s, 0), f = Array(u + l), p = !a; ++r < u;) f[r] = e[r];
            ...
            function q(e, t, n, a, r, o, i, s, c, l) {
                var u = 128 & t,
                    ...
                    v = p ? void 0 : T(e);
                return function m() {
                    for (var y = arguments.length, j = Array(y), x = y; x--;) j[x] = arguments[x];
                    if (d) var _ = W(m),
                        k = g(j, _);
            ...
            function K(e, t, n, a, r, o, i, s) {
                ...
                if (e = p[0], t = p[1], n = p[2], a = p[3], r = p[4], !(s = p[9] = null == p[9] ? c ? 0 : e.length : D(p[9] - l, 0)) && 24 & t && (t &= -25), t && 1 != t) d = 8 == t || 16 == t ? function(e, t, n) {
                    var a = T(e);
                    return function r() {
                        for (var o = arguments.length, i = Array(o), s = o, c = W(r); s--;) i[s] = arguments[s];
                    ...
                    var r = 1 & t,
                        o = T(e);
                    return function t() {
                        for (var i = -1, s = arguments.length, c = -1, l = a.length, u = Array(l + s), f = this && this !== h && this instanceof t ? o : e; ++c < l;) u[c] = a[c];
        ...
        (function(t) {
            ...
            var v, m, y, g = (m = function(e) {
                ...
                for (var e = arguments, t = -1, n = d(e.length - y, 0), a = Array(n); ++t < n;) a[t] = e[y + t];
                t = -1;
                    ...
                    m = function() {
                        var e = p.current,
                            t = n && h.current ? h.current : function(e) {
                                ...
                                var n, a = (n = t, re.reduce((function(e, t) {
                                        return e[t] = n[t], e
                                    }), {})),
                                    r = a.boxSizing;
                ...
                function n(e) {
                    ...
                    i(this, n), (a = t.call(this, e)).toggleCollapsed = function() {
                        ...
                        return a.props.sortKeys && "array" !== u && (p = p.sort()), p.forEach((function(r) {
                            if (n = new Pe(r, e[r]), "array_group" === i && s && (n.name = parseInt(n.name) + s), e.hasOwnProperty(r))
                                if ("object" === n.type) f.push(m.a.createElement(Fe, Object.assign({
                                    key: n.name,
                                    depth: o + 1,
                                    name: n.name,
                                    src: n.value,
            ...
            Be = function(e) {
                ...
                function n(e) {
                    ...
                    return i(this, n), (a = t.call(this, e)).rjvId = Date.now().toString(), a.getListeners = function() {
                        ...
                        var e, t = q.get(a.rjvId, "action", "variable-update"),
                            n = t.name,
                            r = t.namespace,
                            o = t.new_value,
                            i = t.existing_value,
                ...
                return c(n, [{
                    ...
                    value: function() {
                        var e = this.getListeners();
                        for (var t in e) q.removeListener(t + "-" + this.rjvId, e[t])
                    }
                }, {
                    key: "render",
                    value: function() {
